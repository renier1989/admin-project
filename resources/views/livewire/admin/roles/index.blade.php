    ...
    <div class="py-12 w-full">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="flex justify-end mb-2">
                <div 
                wire:click="$emit('show:global-modal', 'admin.roles.modal-roles')"
                class="p-2 bg-green-500 text-white hover:bg-green-400 trastition duration-500 rounded-md cursor-pointer">
                    Create Role
                </div>
            </div>
                        ...
                        <li class="flex justify-between gap-x-6 py-5 items-center">
                            <div class="flex gap-x-4">
                                ...
                                <div class="min-w-0 flex-auto">
                                    <p class="text-2xl font-semibold leading-6 text-gray-900">{{$role->name}}</p>
